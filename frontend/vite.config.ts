    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          ...
          // El enmascarable va aparte: el sistema recorta los bordes, así que
          // su marca es más pequeña. Declarar el mismo fichero como «any
          // maskable» hacía que Android lo recortara y se comiera el icono.
